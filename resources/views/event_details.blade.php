                                    ...
                                    <div  class="btn-group dOddsBox">
                                        ...
                                        <button class="min-max-bet">
                                            <dl class="fancy-info">
                                                ...
                                                <dd>{{ number_format($event_details['data']['event']['match_odds']['min_bet'], 0)}}- {{ \App\Helpers\CustomHelper::format_number($event_details['data']['event']['match_odds']['max_bet'])}}</dd>
                                            </dl>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="row mx-0 odds_header">
                                    <div class="col-md-5 col-7 px-0">
                                        <div  class="minmax mm-fi">
                                            <dl class="fancy-info">
                                                <dt>Min/Max</dt>
                                                <dd>{{ number_format($bookmakers['min_bet'], 0)}}- {{ \App\Helpers\CustomHelper::format_number($bookmakers['max_bet'])}}</dd>
                                            </dl>
                                        </div>
                                    </div>
                                    <div class="col-md-7 col-5 px-0">
